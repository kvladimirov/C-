    ...
    class Program
    {
        ...
        private static void ListAllUsers()
        {
            ...
            foreach (User user in users)
            {
                ...
                Console.WriteLine("AuthorId: {0}", user.FullName);
        ...
        private static void SelectAuthorOfSpecificPost()
        {
            ...
            Console.WriteLine("Post Title: {0}", author.FullName);
            Console.WriteLine();
        }
        ...
        private static void OrderPostsAuthors()
        {
            ...
            List<User> users = blogDbContext.Users
                .Where(user => user.Posts.Count > 0).OrderByDescending(user => user.Id).ToList();
